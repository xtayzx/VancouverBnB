...
<div class="page-content">
    ...
    if($search_result->fetch_row() != 0) {
        ...
        //HOST URL
        echo "<h3>Airbnb URL</h3>";
        echo "<p><a href=\"".$row["host_url"]."\">Click Here</a></p>";
        echo "<br>";
        ...
        //HOST RATES
        echo "<h3>Repsonse Rate</h3>";
        echo "<p>".$row["host_response_rate"]."</p><br>";
        echo "<h3>Acceptance Rate</h3>";
        echo "<p>".$row["host_acceptance_rate"]."</p>";
        echo "<br>";

        //HOST LISITINGS
        echo "<h3>Listings Count</h3>";
        echo "<p>".$row["host_listings_count"]."</p><br>";
        echo "<h3>Total Listings Count</h3>";
        echo "<p>".$row["host_total_listings_count"]."</p>";
        echo "<br>";
