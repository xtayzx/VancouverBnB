...
<div class="register">
    ...
    <form action="register.php" method="post">
        ...
        <input type="text" name="first_name" value="" class="register-fields" required placeholder="First Name" /><br><br>
        ...
        <input type="password" name="password" value="" class="register-fields" required placeholder="Password" /><br><br>
        <input type="password" name="password_confirm" value="" class="register-fields" required placeholder="Confirm Password" />
        <br>
        <br>
        ...
        <select id="neighbourhood_preference" name="neighbourhood_preference">
            ...
            <!-- Display all neighbourhoods in the database -->
            <?php
